// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpawnPoint.cs" company="">
//   
// </copyright>
// <summary>
//   Holder for reflection information generated from POGOProtos/Map/SpawnPoint.proto
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace POGOProtos.Map
{
	...
	public static partial class SpawnPointReflection
	{
		...
		/// <summary>
		/// Initializes static members of the <see cref="SpawnPointReflection"/> class.
		/// </summary>
		static SpawnPointReflection()
		{
			...
			descriptor = pbr::FileDescriptor.FromGeneratedCode(
				...
				new pbr::GeneratedClrTypeInfo(
					...
					{
						new pbr::GeneratedClrTypeInfo(
							typeof(global::POGOProtos.Map.SpawnPoint),
	...
	public sealed partial class SpawnPoint : pb::IMessage<SpawnPoint>
	{
		...
		public static pbr.MessageDescriptor Descriptor
		{
			get
			{
				return global::POGOProtos.Map.SpawnPointReflection.Descriptor.MessageTypes[0];
			}
		}
