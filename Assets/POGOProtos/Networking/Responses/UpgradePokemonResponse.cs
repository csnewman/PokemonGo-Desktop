// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UpgradePokemonResponse.cs" company="">
//   
// </copyright>
// <summary>
//   Holder for reflection information generated from POGOProtos/Networking/Responses/UpgradePokemonResponse.proto
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace POGOProtos.Networking.Responses
{
	...
	public static partial class UpgradePokemonResponseReflection
	{
		...
		/// <summary>
		/// Initializes static members of the <see cref="UpgradePokemonResponseReflection"/> class.
		/// </summary>
	...
	public sealed partial class UpgradePokemonResponse : pb::IMessage<UpgradePokemonResponse>
	{
		...
		/// <summary>
		/// The upgraded pokemon_.
		/// </summary>
		private PokemonData upgradedPokemon_;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="UpgradePokemonResponse"/> class.
		/// </summary>
		...
		public static pbr.MessageDescriptor Descriptor
		{
			get
			{
				return global::POGOProtos.Networking.Responses.UpgradePokemonResponseReflection.Descriptor.MessageTypes[0];
			}
		}
		...
		/// <summary>
		/// Gets or sets the upgraded pokemon.
		/// </summary>
		[global::System.Diagnostics.DebuggerNonUserCodeAttribute]
		public PokemonData UpgradedPokemon
		{
			get
			{
				return upgradedPokemon_;
			}
		...
		/// </summary>
		/// <returns>
		/// The <see cref="UpgradePokemonResponse"/>.
		/// </returns>
		[global::System.Diagnostics.DebuggerNonUserCodeAttribute]
		...
		public bool Equals(UpgradePokemonResponse other)
		{
			...
			if (!object.Equals(UpgradedPokemon, other.UpgradedPokemon))
			{
				return false;
			}
		...
		public override int GetHashCode()
		{
			...
			if (upgradedPokemon_ != null)
			{
				hash ^= UpgradedPokemon.GetHashCode();
			}
