// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BattlePokemonInfo.cs" company="">
//   
// </copyright>
// <summary>
//   Holder for reflection information generated from POGOProtos/Data/Battle/BattlePokemonInfo.proto
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace POGOProtos.Data.Battle
{
	...
	public static partial class BattlePokemonInfoReflection
	{
		...
		/// <summary>
		/// Initializes static members of the <see cref="BattlePokemonInfoReflection"/> class.
		/// </summary>
		static BattlePokemonInfoReflection()
		{
			...
			descriptor = pbr::FileDescriptor.FromGeneratedCode(
				...
				new pbr::GeneratedClrTypeInfo(
					...
					{
						new pbr::GeneratedClrTypeInfo(
							typeof(global::POGOProtos.Data.Battle.BattlePokemonInfo),
							global::POGOProtos.Data.Battle.BattlePokemonInfo.Parser,
							new[] { "PokemonData", "CurrentHealth", "CurrentEnergy" },
							null,
							null,
							null)
					}));
	...
	public sealed partial class BattlePokemonInfo : pb::IMessage<BattlePokemonInfo>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BattlePokemonInfo"/> class.
		/// </summary>
		...
		public static pbr.MessageDescriptor Descriptor
		{
			get
			{
				return global::POGOProtos.Data.Battle.BattlePokemonInfoReflection.Descriptor.MessageTypes[0];
			}
		}
		...
		/// </summary>
		/// <returns>
		/// The <see cref="BattlePokemonInfo"/>.
		/// </returns>
		[global::System.Diagnostics.DebuggerNonUserCodeAttribute]
